...
class BukuModel
{
    ...
    {
        $query = "INSERT INTO buku(judul, penerbit, pengarang, tahun, kategori_id, penerbit_id, harga) VALUES (:judul, :penerbit, :pengarang, :tahun, :kategori_id, :penerbit_id, :harga)";
        $this->db->query($query);
